...
function toggleMenu() {
    ...
    console.log('https://' + window.location.hostname + '/MyLife/' + 'images/hamburgerIcon.png')
    console.log(window.location.hostname);
    console.log(window.location.pathname);
    //check the src attribute
    if (hamburgerIcon.src == 'https://' + window.location.hostname + '/MyLife/' + 'images/hamburgerIcon.png') {
